...
export default function GameCard({ game }) {
	return (
		...
		>
			...
			<div>
				<p className="font-extrabold text-sm sm:text-base">{game.title}</p>
			...
			<a
				...
				className="bg-rose-500 hover:bg-rose-400 dark:bg-sky-700 font-extrabold text-white text-xs sm:text-sm p-2 px-4 rounded-xl dark:hover:bg-sky-500 transition-colors mt-auto"
			>
				Jogar agora
			</a>
		</div>
